...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
   ...
   Is using html tags that will display to screen readers what type of content is displayed on the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

   Display block afftects paddings and margins but with inline it does not.
...
5. Explain why git is valuable to a team of developers.
   ...
   It allows all changes to be seen and shared while also keeping a master copy.
